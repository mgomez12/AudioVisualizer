...
ShaderProgram::ShaderProgram(
  ...
  BindAttributeLocation("vertex_color", 10);
...
void ShaderProgram::BindAttributeLocation(const std::string& name, GLint ix) const {
  glBindAttribLocation(shader_program_, ix, name.c_str());
  GL_CHECK_ERROR();
}
